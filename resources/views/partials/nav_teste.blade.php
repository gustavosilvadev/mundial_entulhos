    ...
    <nav class="header-navbar navbar navbar-expand-lg navbar-shadow container-fluid">
        ...
        <?php if(session('access_permission') == 1){ ?>
            <div class="bd-example">
                ...
                <div class="btn-group">
                    <a class="{{ request()->is('createcalldemand') ? 'btn btn-outline-success' : 'btn dropdown-toggle waves-effect waves-float waves-light' }}" href="{{ request()->is('createcalldemand') ? '#' : url('createcalldemand') }}"><u>NOVA COLOCAÇÃO</u></a>
                </div>
{{--                 
                <div class="btn-group">
