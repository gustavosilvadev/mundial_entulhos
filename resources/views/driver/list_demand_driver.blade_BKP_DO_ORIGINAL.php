...
// if(is_array($call_demands)){
//     foreach($call_demands as $call_demand){

//         echo $call_demand['tipo_servico']."<BR />";
...
{{-- 
                                                    <div class="todo-item-action">
                                                        ...
                                                        <input type="hidden" class="id_call_demand_reg" value="{{ $call_demand->id_demand }}" />
...
// return false;
        ...
        $("#btn_collect_dumpster").click(function(){
            ...
            if(idLandfill > 0){
                ...
                console.log("DAdos caça,b : " + dumpsterNumbers);
