                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="last-name-column" class="form-control" name="address" value="<?php echo $client->address; ?>"/>
                                                    </div>
                                                </div>

                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        <label for="last-name-column">Bairro</label>
                                                        <input type="text" id="last-name-column" class="form-control" name="district" value="<?php echo $client->district; ?>"/>
                                                    </div>
                                                </div>
